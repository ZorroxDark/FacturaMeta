...
public class CancelaRechazoOracle {
	...
	public String plantillaRechazoOracleMetalsa(String razonSocial , String uuid, String emailComprador) {
	...
	public String plantillaRechazoOracleProeza(String razonSocial , String uuid, String emailComprador) {
		StringBuilder template = new StringBuilder();
