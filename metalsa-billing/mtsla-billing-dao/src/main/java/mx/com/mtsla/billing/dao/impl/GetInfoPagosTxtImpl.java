...
@Stateless
public class GetInfoPagosTxtImpl implements GetInfoPagosTxtDao {
	...
	public List<EspecOrdEncaFacElecTxtDTO> getInfoFacPagosEncabezado(FacElectronicaRequest request) {
		...
		try {
			...
			System.out.println("CREA OBJETO getInfoFacPagosEncabezado  ..");
			...
			qlString.append(" CLI_ATEBCOFIDI.dbo.Num2LetF(enc.TotalMonto,enc.monedaP,'',1) Letras_Monto_Total, \n");
			...
			qlString.append(" null Plataforma, --misc01  \n");
			...
			qlString.append(" 'P01' incoterm, --misc32 \n");
			...
			qlString.append(" (SELECT rtrim(Regimen) + ',' AS 'data()' FROM CLI_ATEBCOFIDI.dbo.EmpresaRF where empresa=enc.Empresa FOR XML PATH('')) RegimenFiscal, \n");
			...
			System.out.println("Error getInfoFacPagosEncabezado " + e);
	...
	public List<EspecOrdLineDetCfdTxtDTO> getInfoFacPagosCompleDetalle(FacElectronicaRequest request) {
		...
		try {
			System.out.println("CREA OBJETO getInfoFacPagosCompleDetalle  ..");
			...
			System.out.println("Error getInfoFacPagoCompleDetalle " + e);
	...
	public List<EstrucSecAuxComplePagoTxtDTO> getListaAuxPagosComplePago(FacElectronicaRequest request) {
		...
		try {
			...
			qlString.append(" docto.tipoCambioDR, \n");
			qlString.append(" docto.metodoDePagoDR, \n");
			qlString.append(" docto.numParcialidad, \n");
			qlString.append(" docto.impSaldoAnt, \n");
			qlString.append(" docto.impPagado, \n");
			qlString.append(" docto.impSaldoInsoluto, \n");
			qlString.append(" null DetalleAux_Misc12, \n");
			qlString.append(" null DetalleAux_Misc13, \n");
			qlString.append(" null DetalleAux_Misc14,  \n");
			qlString.append(" null DetalleAux_Misc15, \n");
