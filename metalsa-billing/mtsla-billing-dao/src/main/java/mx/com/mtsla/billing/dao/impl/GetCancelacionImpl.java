...
public class GetCancelacionImpl implements GetCancelacionesDao {
	...
	@SuppressWarnings("finally")
	@Override
	public List<CancelacionInfoAddResponse> getListaCorreoProvedor(List<CancelacionResponse> listaCancelacion) {
		
		System.out.println("CREA OBJETO getListaCorreoProvedor  ..");
		...
		try {
			...
			qlStringC1.append(" from ft_facturas_sup  where upper(uuid) in (");
			qlStringC1.append(qlStringvalores.toString());
			qlStringC1.append(") ");
	...
	@SuppressWarnings("finally")
	@Override
	public List<CancelacionInfoAddResponse> getListaCorreoComprador(List<CancelacionResponse> listaCancelacion) {
		
		System.out.println("CREA OBJETO getListaCorreoComprador  ..");
		...
		try {
			...
			qlStringC1.append(" inner join ctm_ap_invoices_interface d on d.header_attribute1=a.segment1 and a.org_id=d.org_id "); 
